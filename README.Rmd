...
`r badger::badge_custom("dev version", as.character(packageVersion("presize")), "blue", "https://github.com/dcr-unibe-ch/presize")`
[![Actions Status](https://github.com/dcr-unibe-ch/presize/workflows/R-CMD-release/badge.svg)](https://github.com/dcr-unibe-ch/presize/actions)
...
The package website, including more details on the functions, can be found [here](https://dcr-unibe-ch.github.io/presize/).

If you have a question, feel free to make a thread on the [discussion](https://github.com/dcr-unibe-ch/presize/discussions) page.

If you encounter a bug, please create an [issue](https://github.com/dcr-unibe-ch/presize/issues).

## Contributing

Contributions to `presize` are welcome. If you have ideas, open an [issue](https://github.com/dcr-unibe-ch/presize/issues) or a [discussion thread](https://github.com/dcr-unibe-ch/presize/discussions) on GitHub. 

If you want to contribute code, please feel free to fork the repository, make your changes and make a pull request to have them integrated into the package.  New functionality should have accompanying tests and pass continuous integration. See also the [contributing guidelines](https://github.com/dcr-unibe-ch/presize/blob/master/CONTRIBUTING.md).

## Funding

`presize` was largely developed at DCR, with collaboration from CTU Basel. Funding was provided by the Swiss Clinical Trial Organisation.

```{r, echo=FALSE}
knitr::include_graphics("man/figures/Red (3D)_RGB@2x.png")
```
